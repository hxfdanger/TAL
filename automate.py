...
class Automate:
    ...
    def run(self):
        ...
        while not self.fin():
            ...
            print("Buffer=",self.buff.len())
            print("pile=",self.pile.len())
            print("TAILLE DE L'ARBRE=",len(self.tree.get_vertices()))
            ...
            x,y = self.features.get_Data_Set ()



            predict = self.clf.predict(configuration) # Oracle transition
